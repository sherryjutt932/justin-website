...
function setStickyTop() {
    ...
    var discoverMoreWrapperElement = document.getElementsByClassName("discoverMoreWrapper")[0];
    var FAQGroupsElement = document.getElementById("FAQGroups");

    var pos = discoverMoreWrapperElement ? Math.max(((discoverMoreWrapperElement.offsetHeight * (1)) - (60) - (window.innerHeight*0.5)) ,0) : 0;
